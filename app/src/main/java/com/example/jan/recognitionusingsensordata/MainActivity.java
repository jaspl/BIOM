...
public class MainActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer.getAccelAndGraavity(timerTextView);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!newUser) {
                    ...
                    Toast.makeText(MainActivity.this, "wykonaj 5 gestów", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onMovementChanged(String newMovement) {
                ...
                if (newUser) {
                    if (seqence.size() < 5) {
                        ...
                        Toast.makeText(MainActivity.this,"Wykonano już maksymalną liczbę gestów!",Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    private void initialazeSensors(SensorEventListener sensorEventListener) {
    ...
    public void sensors(){
        ...
        initialazeSensors(sensorEventListener);
